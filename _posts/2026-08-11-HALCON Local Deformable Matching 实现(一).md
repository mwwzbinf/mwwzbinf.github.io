...
`find_local_deformable_model` 是 Halcon 中处理局部形变匹配的核心算子。本文基于其底层论文 *Edge-Based Template Matching with a Harmonic Deformation Model*，梳理该算子的核心思想与实现流程，并记录实践过程中遇到的问题与改进方向。
